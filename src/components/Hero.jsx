...
function Hero() {
  ...
  return (
    <div className="bg-white " id='me'>
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="#me" className="-m-1.5 p-1.5">
              <img
                alt="logo"
              src={logo}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 py-20	">
        <div
          aria-hidden="true"
        ...
        <div className='flex justify-center pt-10'>
          <img src={anwar} alt="anwar" width="300px" height="300px" className='rounded-3xl		'/>
        </div>
        <div className="mx-auto max-w-2xl py-1 sm:py-1 lg:py-1 ">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            7 سنوات من التميز في تطوير المواقع
